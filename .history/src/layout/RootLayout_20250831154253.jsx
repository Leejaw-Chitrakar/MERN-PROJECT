    ...
    <div>
      <header>
        ...
        <div className="header-actions">
          {token ? (
            <>
              <Link to="/" style={{ color: "grey" , textDecoration:""}} >Home</Link>
              <Link to="/profile" style={{ color: "grey" , textDecoration:""}} >Profile</Link>
              <Link to="/complain" style={{ color: "grey" , textDecoration:""}} >Complain</Link>
