  ...
  return (
    <div className="home">
      ...
      <div className="container">
        ...
        <div className="gender-selection">
          ...
          <h5>Filter Price:</h5>
          <input type="text" name="price" id="price" className="priceCollection" onChange={handlePriceChange} value={priceFilter} placeholder="0"/>
        </div>
    ...
    <h3>Available Products:</h3>
      <ul style={{textDecoration:'none', }}>
        {filterPrice.filter((outfit) => outfit.gender === activeGender)
        .map(outfit => (
          <li key={outfit.id } >
          ...
          <div className="gallery" style={{ display: Number(priceFilter) === 0 ? "" : "none" }}>
            <h2 style={{ display: Number(priceFilter) === 0 || Number(priceFilter)<== outfits.? "none" : "" }}>No any Items or Product available</h2>
            {filteredOutfits
              .filter((outfit) => outfit.gender === "women")
              .map((outfit) => (
                <OutfitCard
