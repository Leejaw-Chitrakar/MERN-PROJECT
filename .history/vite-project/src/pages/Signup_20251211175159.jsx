...
const handleSubmit = async () => {
    ...
    // }
     try {
      // Step 1: Send Signup credentials to the backend
      ...
      if (response.data.authtoken) {
        ...
        console.error("Signup failed:", response.data.error || "Unknown error");
      }
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* remaining section of Signup page */}
         <Flex vertical gap="small" style={{ width: "100%" }}>
          <Button
